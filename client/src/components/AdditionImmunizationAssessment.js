    ...
    useEffect(() => {
      ...
      const addRecSubmit = async (event) => {
        ...
        try{
           ...
           const response = await axios.post(`childhealth/addassessment/${recordid}`,{findings,notes,serviceProvider});
            ...
            <div className="row mb-5">
                    ...
                    <div className="col text-start">
                        ...
                        <input type="text"  className="form-control Addition_Immunization_textarea" 
                            id="exampleFormControlTextarea1" disabled value={vitalSign.weight}
                            style={{backgroundColor: "#CCE8DE"}}/>
                    </div>        
                    <div className="col text-start">
                        <label htmlFor="exampleFormControlTextarea1" className="form-label">Height</label>
                        <input type="text"  className="form-control Addition_Immunization_textarea"disabled 
                            id="exampleFormControlTextarea1" value={vitalSign.height}
                            style={{backgroundColor: "#CCE8DE"}}/>
                    </div>
                    <div className="col text-start">
                        <label htmlFor="exampleFormControlTextarea1" className="form-label">Temperature</label>
                        <input type="text"  className="form-control Addition_Immunization_textarea" 
                            id="exampleFormControlTextarea1" disabled value={vitalSign.temp}
                            style={{backgroundColor: "#CCE8DE"}}/>
                    </div>
                </div>
